                        ...
                        formatter: (value, index) => {
                            ...
                            switch (this.datatype) {
                                case "day": {
                                    ...
                                    if (index === 0 || index === 4) {
                                        s = "-";
                                        texts = [TimeFormat.getTimeByPattern(date, "MM"), TimeFormat.getTimeByPattern(date, "dd")];
                                    }
                                    break;
                                }
                                case "week": {
                                ...
                                case "year": {
                                    texts = [TimeFormat.getTimeByPattern(date, "yyyy"), TimeFormat.getTimeByPattern(date, "MM")];
                                    break;
                                }
                            }
                            return texts.join(s);
